...
class TasksApiTest extends TestCase
{
    ...
    {
        factory(Acacha\TodosBackend\Task::class, $numberOfTasks)->create();
    }
    ...
    {
        return factory(Acacha\TodosBackend\Task::class)->make();
    }
    ...
    {
        return factory(Acacha\TodosBackend\Task::class)->create();
    }
